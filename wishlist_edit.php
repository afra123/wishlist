...
<body id="admin_page">
	...
	<h4 class="center-align" style="margin-top: 5%;margin-bottom:2%;">Edit Wishlist <a href="<?= base_url() ?>">Wishlist</a></h4>

	<!--login form section start-->
	<div class="row white" style="padding:10px;padding-bottom: 40px">
		<br><br>
		<div class="col 14 m4 s12"></div>
		<div class="col 14 m4 s12" style="border:1px solid #000;" id="wish_form">
			<br><br>

			<?= form_open('User_controller/edit_wish',array('class'=>'form')) ?>
			...
			<div class="input-field">
				<input type="text" name="title" id="title" value="<?= $list->wishlist_title; ?>">
				<label for="title">Title</label>
			</div>
			<div class="input-field">
				<input type="text" name="description" id="description" value="<?= $list->wishlist_desc ?>">
			...
			<?php } ?>
			<br><br>
			<center><a href="login" style="color: #000">Already Created!</a></center><br><br>
		</div>
